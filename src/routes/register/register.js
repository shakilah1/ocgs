    ...
    return (
        ...
        >
            <Form className="flex flex-col space-y-6 p-2 md:p-4">
                ...
                <Field name="fullname" type="text" className="px-4 py-2 text-gray-700 border-2 border-gray-600 text-gray-700 font-semibold rounded-md" />
                </span>
                ...
                <span>
                <button type="submit" className="bg-green-500 font-semibold text-white px-4 py-2 rounded-md w-1/2">Submit</button>
                </span>
